...
export const financeApi = {
  ...
  validatePayment: (id: string) => api.post(`/payments/${id}/validate/`),
  rejectPayment: (id: string, reason: string) => api.post(`/payments/${id}/reject/`, { reason }),
  refundPayment: (id: string, reason: string) => api.post(`/payments/${id}/refund/`, { reason }),
